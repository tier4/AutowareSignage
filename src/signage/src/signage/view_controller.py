...
from python_qt_binding.QtCore import Property
from python_qt_binding.QtCore import Signal

class ViewControllerProperty(QObject):
    _view_mode_changed_signal = Signal(str)
    _route_name_signal = Signal(list)
    _get_departure_station_name_signal = Signal(list)
    _get_arrival_station_name_signal = Signal(list)
    _get_next_station_list_signal = Signal(list)
    _get_previous_station_name_signal = Signal(list)
    _get_remain_arrive_time_text_signal = Signal(str)
    _get_remain_depart_time_text_signal = Signal(str)
    _get_display_time_signal = Signal(bool)
    _get_clock_string_signal = Signal(str)
    _get_monitor_height_signal = Signal(int)
    _get_monitor_width_signal = Signal(int)
    _get_size_ratio_signal = Signal(float)
    ...
    @Property(str, notify=_view_mode_changed_signal)
    def view_mode(self):
    ...
    @Property(list, notify=_route_name_signal)
    def route_name(self):
    ...
    # QMLへ出発地バス停名を反映させる
    @Property(list, notify=_get_departure_station_name_signal)
    ...
    # QMLへ到着地バス停名を反映させる
    @Property(list, notify=_get_arrival_station_name_signal)
    ...
    # QMLへのsignal
    @Property(list, notify=_get_next_station_list_signal)
    ...
    # QMLへのsignal
    @Property(list, notify=_get_previous_station_name_signal)
    ...
    # QMLへroute_nameを反映させる
    @Property("QString", notify=_get_remain_arrive_time_text_signal)
    ...
    # QMLへroute_nameを反映させる
    @Property("QString", notify=_get_remain_depart_time_text_signal)
    ...
    # QMLへのsignal
    @Property(bool, notify=_get_display_time_signal)
    ...
    # QMLへroute_nameを反映させる
    @Property("QString", notify=_get_clock_string_signal)
    ...
    @Property(int, notify=_get_monitor_width_signal)
    ...
    @Property(int, notify=_get_monitor_height_signal)
    ...
    @Property(float, notify=_get_size_ratio_signal)
    def size_ratio(self):
